    ...
    <div id="id02" class="modal">
        <form class="model-content" action="database\register.php" method="POST">
            ...
            <div>
                ...
                <input type="password" name="userpassword" id="pass" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" title='Your password must contain at least one uppercase or lowercase letter, 1 number and a minimum of 6 characters'><br><br>
                <!--<label for="password"> Password</label><br>
